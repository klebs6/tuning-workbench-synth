...
impl SynthesiserSound for TWSSound {}

impl TWSSound {
    
    pub fn new(i: *mut TuningworkbenchsynthAudioProcessor) -> Self {
    ...
    pub fn applies_to_note(&mut self, _0: i32) -> bool {
    ...
    pub fn applies_to_channel(&mut self, _0: i32) -> bool {
...
pub struct TWSVoice {
    synth_mod_wheel:           Atomic<i32>,
    note_num:                  i32,
    pw_amount:                 f64,
    prior_renderedpw:          f64, // default = 0
    prior_rendered_uni_spread: f64, // default = 0
    p:                         *mut TuningworkbenchsynthAudioProcessor,
    current_angle:             [f64; MAX_UNISON],
    angle_delta:               [f64; MAX_UNISON],
    level:                     f64, // default = 0.0
    sub_angle:                 f64,
    sub_angle_delta:           f64,
    nunison:                   i32,
    d_delta:                   [f64; MAX_UNISON],
    pan:                       [f64; MAX_UNISON],
    pan_bufferl:               [f64; N_PAN],
    pan_bufferr:               [f64; N_PAN],
    sin_level:                 SmoothedValue<f32>,
    square_level:              SmoothedValue<f32>,
    saw_level:                 SmoothedValue<f32>,
    tri_level:                 SmoothedValue<f32>,
    sub_level:                 SmoothedValue<f32>,
    filter_cut:                SmoothedValue<f32>,
    filter_res:                SmoothedValue<f32>,
    filter_depth:              SmoothedValue<f32>,
    filterl:                   StateVariableFilter<f32>,
    filterr:                   StateVariableFilter<f32>,
    filter_type_at_outset:     i32,

    /**
      | Pluck oscillator
      |
      */
    pluck_delay_line:          Vec<f32>,

    pluck_delay_line_size:     usize,
    pluck_sample_delay:        f32,
    frac_pluck_sample_delay:   f32,
    i_pluck_sample_delay:      i32,
    pluck_delay_pos:           usize,
    pluck_weight:              SmoothedValue<f32>,
    pluck_atten:               SmoothedValue<f32>,
    pluck_level:               SmoothedValue<f32>,
    pluck_atten_norm:          f32,
    lfo_time:                  f32,
    lfo_dtime:                 f32,
    lfo_angle:                 f32,
    lfo_last_rand:             SmoothedValue<f32>,
    lfo_last_square:           SmoothedValue<f32>,
    needs_retune:              AtomicBool,
    modwheel_level:            Atomic<i32>,

    /**
      | pluck env has no user parameters
      |
      */
    ampenv:                    ADSR,
...
impl SynthesiserVoice      for TWSVoice {}
impl TuningUpdatedListener for TWSVoice {}

pub mod tws_voice {
    pub const N_PAN: i32 = 1000;
}
...
impl TWSVoice {
    ...
    pub fn can_play_sound(&mut self, sound: *mut SynthesiserSound) -> bool {
    ...
    pub fn pitch_wheel_moved(&mut self, pw: i32)  {
    ...
    pub fn render_next_block(&mut self, 
        output_buffer: &mut AudioSampleBuffer,
        start_sample:  i32,
        num_samples:   i32)  {
    ...
    pub fn set_pitch_wheel(&mut self, pw: i32)  {
    ...
    pub fn pitch_wheel_note_shift(&mut self) -> f64 {
    ...
    pub fn frequency_for_fractional_note(&mut self, frac_note: f64) -> f64 {
...
#[inline] pub fn analogish_square(x: f64) -> f64 {
...
#[inline] pub fn analogish_tri(x: f64) -> f64 {
...
#[inline] pub fn analogish_saw(x: f64) -> f64 {
...
impl TWSVoice {
    ...
    pub fn frequency_for_fractional_note(&mut self, fnote: f64) -> f64 {
...
impl TWSSynthesiser {
    ...
    /**
      | * This is where we can place per-synth
      | as opposed to per-voice things * in our
      | case: a delay line and a saturator and
      | a master gain
      |
      */
